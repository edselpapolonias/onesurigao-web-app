// src/components/superadmin/SuperAdminPinned.js
import React, { useState, useEffect } from "react";
import axios from "axios";
import SuperAdminLayout from "../ReusableBar/SuperAdminLayout";

const API_URL = "http://127.0.0.1:8000/superadmin/announcements/?pinned=true";
...
const PinnedCard = ({ announcement }) => {
  ...
  return (
    <div style={{
      ...
      overflow: "hidden", borderLeft: "4px solid #f59e0b",
    ...
    >
      ...
      <div style={{ padding: "0 20px 14px", fontSize: 14, color: "#444", fontFamily: "'Segoe UI', sans-serif", lineHeight: 1.75, whiteSpace: "pre-wrap" }}>
        ...
        {isLong && (
          <button
            ...
            style={{ display: "flex", alignItems: "center", gap: 4, marginTop: 8, background: "none", border: "none", cursor: "pointer", fontSize: 13, fontWeight: 700, color: "#f59e0b", fontFamily: "'Segoe UI', sans-serif", padding: 0 }}
          >
      ...
      <div style={{ padding: "10px 20px", borderTop: "1px solid #fef3c7", background: "#fffbeb", display: "flex", alignItems: "center", gap: 6 }}>
        <OfficeIcon />
        <span style={{ fontSize: 12, color: "#92400e", fontFamily: "'Segoe UI', sans-serif" }}>
    ...
    <SuperAdminLayout>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ margin: "4px 0 0", fontSize: 13, color: "#888", fontFamily: "'Segoe UI', sans-serif" }}>
          Important notices pinned by city offices
        </p>
      </div>
      ...
      {!loading && announcements.map(a => (
        <PinnedCard key={a.id} announcement={a} />
      ))}
...
export default SuperAdminPinned;